...
if (deposer_annonce($depose_titre, $depose_categories, $depose_description, $depose_prix, $depose_photo, $depose_lat, $depose_lon, $date)=="ok"){
    echo  "Votre annonce a été déposé. <a href='http://localhost/ProjetIPS/mon_compte/mon_compte.php'>Retournez à votre page personel </a>";
    echo '<meta http-equiv="refresh" content="2;URL=http://localhost/ProjetIPS/mon_compte/mon_compte.php" />';
}
